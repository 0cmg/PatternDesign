...
public class Test {
    public static void main(String[] args) {
        ArticleMementoManage articleMementoManage = new ArticleMementoManage();
        Article article = new Article("如影随形的设计模式A","手记内容A","手记图片A");
        ArticleMemento articleMemento = article.saveToMemento();

        articleMementoManage.addMemento(articleMemento);

        System.out.println("标题："+article.getTitle()+" 内容："+article.getContent()+" 图片："+article.getImgs());;
        System.out.println("手记的完整信息："+article);
        ...
        System.out.println("修改后手记完整信息："+article);
        ...
        articleMemento = articleMementoManage.getMemento();
        ...
        System.out.println("回退后的手记完整信息："+article);
